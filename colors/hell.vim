...
" BufTabLine
exe 'hi BufTabLineCurrent guifg='s:fg2' guibg='s:fg2' gui=underline'
exe 'hi BufTabLineHidden guifg='s:bg4' guibg='s:bg gui=underline'
exe 'hi BufTabLineFill guifg='s:fg' guibg='s:bg gui=underline'
